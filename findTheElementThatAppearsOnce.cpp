...
int getSingle(int arr[], int n)
{
	...
	{
		/*
		*The expression "one & arr[i]" gives the bits that are there in both 'ones' and new element from arr[]. We add these bits to
		...
		* 'ones' and 'twos'. common_bit_mask contains all these bits as 0, so that the bits can be removed 
		* from 'ones' and 'twos'
		* 
		...
		*Value of twos will be set as 0, 3, 1 and 0 after 1st, 2nd, 3rd and 4th iterations respectively
		*/
